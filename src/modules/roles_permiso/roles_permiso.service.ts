...
export class RolesPermisoService {
    constructor(@InjectRepository(RolesPermisosEntity)private rolespermisosRepository : Repository<RolesPermisosEntity>, private permisoService : PermisosService, private rolesService : RolesService){}
